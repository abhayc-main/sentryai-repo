...
<div className="grid sm:grid-cols-2 gap-4 mt-6 mb-9">

<Card href="/resources/hardware-device/hardware-design">
...
<Card href="/resources/hardware-device/hardware-render">
